...
const Home = () => {
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 bg-slate-500">
        <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 bg-pink-300">
          {products?.map((product) => (
            <div className="border border-gray-300 py-8 max-w-sm mx-auto w-full bg-purple-400">
              <a key={product.id} className="group">
                <img
                  src={product.images[0]}
                  className="h-60 w-auto object-cover object-center mx-auto"
                />
                <div className="mx-6 bg-yellow-200">
                  <div className="py-4 bg-green-300">
                    <h3 className="mt-4 text-sm text-gray-700 bg-cyan-300">{product.title}</h3>
